    ...
    <div class="content_addrcp">
        <form class="form_rcp" method="POST" enctype="multipart/form-data">
            <fieldset>
                ...
                <input class="inputtitle_addrcp" type="text" name="name" value="<?php echo $name;  ?>  ">        <select name="type">
            ...
            <div id="addimgdiv-addrcp">
                <fieldset>
                    <legend>Add an image for your recipe<span class="signup_required" >*</span></legend>
                    <input class="file_addrcp" type="file" name="image" value="<?php echo $image; ?>"/>
                </fieldset>

                <fieldset>
                    <legend>Add time for recipe in minutes<span class="signup_required" >*</span></legend>
